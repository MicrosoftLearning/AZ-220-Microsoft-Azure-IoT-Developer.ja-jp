...
1. デプロイが完了した後、テンプレートの出力値を確認するには、左側のナビゲーション領域で **[出力]** をクリックします。
    ...
    * deviceIDs
    ...
    > **重要**: deviceIDs の出力には、各デバイスの接続文字列の JSON 配列が含まれています。 適当なテキスト エディターを使って、接続文字列を抽出します。
...
1. **[環境名]** フィールドに、「**tsi-az220-training-<自分の ID>** 」と入力します。
...
1. **[タイムスタンプ]** セクションでは **[プロパティ名]** を空のままにします。
